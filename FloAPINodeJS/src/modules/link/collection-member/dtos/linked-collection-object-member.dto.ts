...
import {
  IsDefined,
  IsIn, IsInt, IsNotEmpty, IsNumber, IsOptional, IsPositive,
  IsString
} from 'class-validator';
import { OBJ_TYPE } from '../../../../common/constants/common';
import { CheckObjectHref, CheckObjectId } from '../../../../common/decorators';
...
export class LinkedCollectionObjectMemberDto extends IsTrashDto {
  @IsInt()
  @IsOptional()
  id?: number;
