...
import { LinkedCollectionObjectDto } from "./linked-collection-object.dto";

export class LinkedCollectionParamError
implements ParamError<LinkedCollectionObjectDto> {
...
implements RequestParamError<LinkedCollectionObjectDto> {
