...
BEGIN
  ...
  -- CHECK existed creator
    ...
    VALUES
    (pnUserId, pvTitle, pvUid, ifnull(pvRoomUrl, ''), pnEnableChatHistory, pnCreatedDate, pnUpdatedDate);
    #
    ...
    VALUES
      (pnUserId, nchannelId, pvEmail, pvEmail, 1, pvTitle, pvDescription, pvAvatar, ifnull(pnVip, 0), pnEnableChatHistory, pnCreatedDate, pnCreatedDate, pnUpdatedDate);
