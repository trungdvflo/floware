...
BEGIN
  ...
  SELECT cm.id, cm.channel_id, cc.uid, cm.email, cm.is_creator, cm.description
        ,cm.vip, cm.revoke_time, cm.updated_date, cm.created_date, cm.join_time, cm.view_chat_history
        ,cc.room_url, cc.enable_chat_history, COALESCE(cm.title, cc.title, '') title
