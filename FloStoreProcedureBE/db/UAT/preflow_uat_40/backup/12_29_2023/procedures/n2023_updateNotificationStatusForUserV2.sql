...
n2023_updateNotificationStatusForUser:BEGIN
  ...
  END IF;
  --
  SELECT nID = n2023_createUserNotification(pnNotiID, pnStatus, pdActionTime, pnUpdatedDate, NULL, pnUserID);
  ...
  ELSE
    ...
    VALUES
          (pnUserID, pnNotiID, pnStatus, ifnull(pdActionTime, 0),  nUpdatedDate, nUpdatedDate);
    --
    SELECT last_insert_id() INTO nID;
    --
  END IF;*/
  -- send last modified
  SET nReturn = m2023_insertAPILastModify('collection_activity', pnUserID, nUpdatedDate);
  --
