...
BEGIN
  ...
  -- CHECK existed creator
    ...
    VALUES
    (pnUserId, COALESCE(pvShareTitle, pvTitle, ''), pvUid, ifnull(pvRoomUrl, ''), nEnableChatHistory, pnCreatedDate, pnUpdatedDate);
    #
    ...
    VALUES
      (pnUserId, nchannelId, pvEmail, pvEmail, 1, COALESCE(pvTitle, pvShareTitle, ''), 
