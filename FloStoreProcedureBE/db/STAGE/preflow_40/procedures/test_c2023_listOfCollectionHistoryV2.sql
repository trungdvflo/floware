CREATE PROCEDURE `test_c2023_listOfCollectionHistoryV2`(pnCollectionId    BIGINT(20)
...
BEGIN
 ...
 -- DEFAULT IS ASC
  ...
  END IF;
  --
  EXPLAIN SELECT ch.id AS id, ch.collection_activity_id, ch.email, ch.action, ch.action_time, ch.content
