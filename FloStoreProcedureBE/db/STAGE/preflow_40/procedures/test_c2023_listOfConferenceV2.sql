CREATE PROCEDURE `test_c2023_listOfConferenceV2`(pvKeyword       TEXT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
                                                            ,pvEmails          TEXT
...
BEGIN
  ...
  --
  EXPLAIN SELECT cm.id, cm.channel_id, cc.uid, cm.email, cm.is_creator, cm.description
