CREATE FUNCTION `c2022_sendLastModifyShare`(vApiName             VARCHAR(255)
...
BEGIN
  ...
  api_loop: LOOP
    ...
    END IF;
    # 2. main UPDATE
    SET nReturn = modify_insertAPILastModify(vApiName, nUserId, nLastModifyDate);
    --
    ...
    IF vApiName = 'collection_comment'
       ...
       THEN 
      # main UPDATE
      SET nReturn = modify_insertAPILastModify('collection_activity', nUserId, nLastModifyDate);
      --
    END IF;
    --
  END LOOP api_loop;
