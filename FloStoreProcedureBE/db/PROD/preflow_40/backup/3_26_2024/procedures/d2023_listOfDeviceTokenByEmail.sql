...
d2023_listOfDevice : BEGIN
  ...
  END IF;
  --
  SET vDeviceType = '0,1,2,3,4'; -- 'IPAD' THEN '1,2' -- 'IPHONE' THEN '0,3,4'
  --
  SELECT u.username, dt.device_type, NULL device_uid, dt.device_token, dt.user_id, dt.cert_env, dt.env_silent
