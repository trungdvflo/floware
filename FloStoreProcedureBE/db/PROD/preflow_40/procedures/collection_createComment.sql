CREATE PROCEDURE `collection_createComment`(nID                  BIGINT(20)
...
sp_createComment: BEGIN
  ...
  IF ifnull(nID, 0) > 0 THEN
    --
    SET nCommentID = collection_updateComment(nID, nUserId, nActionTime, vComment, updatedDate);
    --
  ELSE
    --
    SET nCommentID = collection_createComment(collectionId, objectUid, objectType
