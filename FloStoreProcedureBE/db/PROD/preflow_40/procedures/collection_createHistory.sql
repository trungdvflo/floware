CREATE PROCEDURE `collection_createHistory`(collectionId         BIGINT(20)
...
sp_createHistory:BEGIN
  ...
  START TRANSACTION;
  -- CHECK permission
  SET nPermission = collection_checkPermissionHistory(0, collectionId, objectUid, nUserId);
  ...
  ELSE
    ...
    SET nCAID = collection_createCollectionActivity(collectionId, objectUid, objectType, createdDate, updatedDate);
    --
