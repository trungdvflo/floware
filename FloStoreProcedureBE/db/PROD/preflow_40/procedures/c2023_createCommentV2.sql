CREATE PROCEDURE `c2023_createCommentV2`(pnID                  BIGINT(20)
...
sp_createComment: BEGIN
  ...
  IF ifnull(pnID, 0) > 0 THEN
    --
    SET nCommentID = c2023_updateCommentV2(pnID, pnUserId, pnActionTime, pvComment, pnDraft, pnUpdatedDate);
    --
  ELSE
    --
    SET nCommentID = c2023_createCommentV2(pnCollectionId, pvObjectUid, pvObjectType
                            ,pnUserId, pnActionTime, pvComment, pnDraft, pnParentId, pnCreatedDate, pnUpdatedDate);
    --
  END IF;
  --
  COMMIT;
