CREATE PROCEDURE `collection_removeComment`(nID                   BIGINT(20)
                                                             ,nUserId                BIGINT(20)
...
sp_removeComment: BEGIN
  ...
  IF ifnull(nCommentID, 0) > 0 THEN
    ...
    ELSE
      --
      SET nReturn = collection_generateDeletedItemForShared('COLLECTION_COMMENT', nCollectionId, nID, nDeleteTime);
      --
    END IF;
  ...
  VALUES
    (nCAID, vEmail, 62, deleteTime, '', deleteTime, deleteTime)
