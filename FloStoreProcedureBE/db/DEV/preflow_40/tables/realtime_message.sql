CREATE TABLE `realtime_message` (
  ...
  `uid` varchar(300) CHARACTER SET latin1 NOT NULL,
  `code` varchar(100) CHARACTER SET latin1 NOT NULL,
  `from` varchar(100) CHARACTER SET latin1 NOT NULL,
  `type` enum('NOTIFICATION','EVENT','CHAT') CHARACTER SET latin1 NOT NULL,
  ...
  `send_type` enum('CHANNEL','USER','BROADCAST') CHARACTER SET latin1 NOT NULL,
  `to_channel` varchar(300) CHARACTER SET latin1 DEFAULT NULL COMMENT 'channel name',
  `parent_uid` varchar(100) CHARACTER SET latin1 DEFAULT NULL,
