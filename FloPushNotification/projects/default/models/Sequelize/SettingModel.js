...
const Model = {
    ...
    attributes: (sequelize, DataTypes) => {
        const Setting = sequelize.define(config.tableName, {
            id: {
            ...
            infobox_order: {
                type: DataTypes.STRING,
                default: '[{"type":"event", "order":1},{"type":"todo", "order":2},{"type":"note", "order":3},{"type":"email", "order":4}]',
                require: true
            },
            ...
            emailbox_order: {
                type: DataTypes.STRING,
                default: '[{"type":"mail", "order":1, "show":1},{"type":"contact", "order":2, "show":1}]',
                require: true
            },
