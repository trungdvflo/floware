module.exports = {
    ...
    S3_DAV: {
        AWS_S3_ACCESS_KEY_ID: process.env.DAV_S3_ACCESS_KEY_ID,
        AWS_S3_SECRET_ACCESS_KEY: process.env.DAV_S3_SECRET_ACCESS_KEY,
        AWS_S3_ENDPOINT: process.env.DAV_S3_ENDPOINT,
        AWS_S3_REGION: process.env.DAV_S3_REGION,
        AWS_S3_BUCKET: process.env.DAV_S3_BUCKET
    }
