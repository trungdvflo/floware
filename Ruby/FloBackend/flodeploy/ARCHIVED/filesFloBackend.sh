#test enviroment server: https://test.floware.com:8026
...
#################################################
# set param for email
# export EMAIL_SERVER='flomail.net'
#reload env
...
#root of code
pFloProd="/home/ubuntu/cong.tran/FloWare/FloBackend"
#admin code
# pFloAdmin=$pFloProd/FloAdmin
#flol client code
# pFloClient=$pFloProd/FlowOnlineClient
#ruby code
pFloRubyServer=$pFloProd/FloBackend
#nodejs code
# pDoMailServer=$pFloProd/DoMailServer

#################################################
#define path of code in /var/www
pFloRootDes="/var/www/FloOnline2018Nov/Test/FloOnlineServer"
#admin
# pFloAdminDes=$pFloRootDes/FloOnlineSSL/FloAdmin
#flol client
# pFloClientDes=$pFloRootDes/FloOnlineTest/www_prod
#ruby
pFloRubyDes=$pFloRootDes/latestVersion
#domail - nodejs
# pFloDoMailDes=$pFloRootDes/FloOnlineSSL/DoMailServer
...
# rsync -azh ${pFloClient}/www/css/ ${pFloClientDes}/css/
# rsync -azh ${pFloClient}/www/js/flol.js ${pFloClientDes}/js/flol.js
...
# rsync -azh ${pFloAdmin}/www/css/ ${pFloAdminDes}/css/
# rsync -azh ${pFloAdmin}/www/images/ ${pFloAdminDes}/images/
# rsync -azh ${pFloAdmin}/www/libs/ ${pFloAdminDes}/libs/
# rsync -azh ${pFloAdmin}/www/js/flol.js ${pFloAdminDes}/js/flol.js
...
# cd $pFloDoMailDes/
# forever stop app.js
# NODE_ENV=production MODE=ssl forever start app.js

#################################################
echo "---> done! <----"
echo "---> 1 -Please visit FLOL: https://test.floware.com:8026 <----"
echo "---> 2 -Please visit Flo Admin: https://test.floware.com:8048 <----"
