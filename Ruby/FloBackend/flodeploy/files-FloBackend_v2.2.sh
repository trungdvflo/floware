...
## DEFINE PARAMETERS
FLOAPP_DIR="/var/www/FloOnline2018Nov/Test/FloOnlineServer/v2.2"
HTTP_HOST_NAME="https://test.floware.com:8026"
FLOL_CALDAV_SERVER_URL="https://flo.floware.com:8031/calendarserver.php/calendars/"
HTTP_HOST_NAME_BG="https://test.floware.com:8026/images/"
HTTP_HOST_NAME_FOR_BETA="https://beta.floware.com:8036"
FLOL_CARDDAV_SERVER_URL="http://flo.floware.com:8031/addressbookserver.php/addressbooks/"
IMAP_FOLDER_PATH="/maildata/vhosts/flomail.net/"
API_FROM_EMAIL_SUPPORT="support@flomail.net"
UPLOAD_FILE_PATH="/maildata/floCloud/"
...
if [ -d /tmp/FloBackend ]; then
    ...
    echo "2- git clone git@github.com:LeftCoastLogic/FloBackend.git --branch v2.2"
    git clone git@github.com:LeftCoastLogic/FloBackend.git FloBackend --branch v2.2 
fi
...
echo "bundle install --without development test" && bundle install --without development test
