...
class Api::Web::CaldavController < Api::Web::BaseController
  include AppUtils
  ...
  def get_calendar_objects
    ...
    # It impacts to performance significantly
    # So this code is temporarily commented in
